...
<body>
    ...
    <span id="home" class="top">Home</span> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <span id="our mission" class="top"><a
            ...
            work</a></span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"<a href="profile-page.php"><span id="user-profile" class="top">User Profile</span></a> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    ...
    <div id="donatediv">
        <a href="dono_s.php"><input type="button" value="DONATE" id="donate_button"></a>
    </div>
    ...
    <span>
        ...
        <form class="article1" id="firstarticle">
            ...
            <br>
            <a href="article4.html"> <input type="button" value="Explore More &#8594 " class="readmore1" "></a>
        </form>
        ...
        <form class=" article1" id="secondarticle">
                ...
                <br>
                <a href="article2.html"> <input type="button" value="Explore More &#8594 " class="readmore1"></a>
        </form>
        ...
        <form class="article1" id="thirdarticle">
            ...
            <h4>According to FAO estimates in ‘The State of Food Security and Nutrition in
                ...
                India</h4>
            <br>
            <a href="article1.html"> <input type="button" value="Explore More &#8594 " class="readmore1"></a>
        </form>
        ...
        <form class="article1" id="fourtharticle">
            ...
            <br>
            <a href="article3.html"><input type="button" value="Explore More &#8594 " class="readmore1"></a>
        </form>
