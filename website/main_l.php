...
<body>
    ...
    <span id="contact_us" class="top"><a href="contact-us.php" style="text-decoration: none; color: white;">Contact
            ...
            style="text-decoration: none; color: rgb(255, 255, 255);">FAQ</a></span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href="profile-page.php"><span id="home" class="top">User Profile</span></a> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <a href="PHP/logout.php"><button type="button" class="btn btn-danger">Logout</button></a>&nbsp
</nav>
</header>
                                                   <!-- edit2 ends -->
    <br>
