    ...
    <span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm article_1">
                    <div class="form-group ">
                        ...
                        <br>
                        <center><a href="article4.html"> <button type="submit" class="btn btn-success" >Explore</button></a></center>
                    </div>
                </div>
             ...
             <h6>India was home to the largest number of undernourished people
                ...
                <br>
                <center><a href="article2.html"> <button type="submit" class="btn btn-success">Explore</button></a></center>
            ...
            <h6>According to FAO estimates in ‘The State of Food Security and Nutrition in
                ...
                India</h4>
            <br>
            <center><a href="article1.html"> <button type="submit" class="btn btn-success">Explore</button></a></center>
            ...
            <br>
            <center><a href="article3.html"> <button type="submit" class="btn btn-success">Explore</button></a></center>
            </div>
        </div>
    </div>
</div>
