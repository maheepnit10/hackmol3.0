...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $food=$_POST['food'];
        ...
        $query="insert into donations (d_id,name,contact,location,location_1,pincode,food) values ('$d_id','$name','$contact','$location','$location_1','$pincode','$food')";
        ...
        <div class="row">
            ...
            <div class="col-md-6 donate-right">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <label>Pincode</label>
                        <input type="text" name="pincode" class="form-control" minlength="6" maxlength="6" required>                        
                    </div>
                    <div class="form-group">
